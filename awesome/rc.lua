...
globalkeys = awful.util.table.join(
  ...
  awful.key({ modkey }, "F5",     function () awful.util.spawn('backlight -10') end),
  awful.key({ modkey }, "F6",     function () awful.util.spawn('backlight  10') end),
  awful.key({ modkey, "Shift" }, "i",     function () awful.util.spawn('xcalib -i -a') end),
